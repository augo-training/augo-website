...
import { COPY, NICE_ATHLETES_PATH, NICE_ATHLETES_UNLOCK_KEY } from '../components/niceAthletes/constants'
...
export default function NiceAthletes() {
    const { unlocked, unlock } = useCaptureUnlock(NICE_ATHLETES_UNLOCK_KEY)
