...
export const coaches: Coach[] = [
    ...
    },
    {
        ...
        gender: 'male',
        tagline:
            'Detail-obsessed trail and road coach for the "professional amateur" — disciplined and self-aware.',
        isFoundingCoach: false,
        status: 'accepting',
        disciplines: ['running'],
        specialties: ['trail running', 'road running', '5K to ultras', 'multi-day events'],
        location: { city: 'Salzburg', country: 'Austria', countryCode: 'AT', timezone: 'Europe/Vienna' },
        coachesRemote: true,
        languages: [EN, IT, MT],
        ...
        bio: {
            short:
                'Detail-oriented, passionate, focused on making athletes smarter and more independent — not more dependent.',
            long: [
                "Niki coaches trail and road running from 5K to ultras and multi-day events.",
                'His ideal athlete is the "professional amateur": dedicated, motivated, treats sport seriously — and has a real life around it.',
            ],
            philosophy: 'Reward the process and the effort. Make the athlete more independent.',
        },
        media: { portrait: nellPortrait },
        socials: { website: 'https://www.bornonthetrail.com' },
    },
    {
        slug: 'max-kinzlbauer',
        name: 'Max Kinzlbauer',
